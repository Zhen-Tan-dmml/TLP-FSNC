...
def load_data_pretrain(dataset_source):
    if dataset_source in class_split.keys():
...
for dataset in ['Amazon_eletronics','cora-full','dblp']:
...
#for dataset in ['ogbn-arxiv']:
    ...
    for avail_train_num_per_class in [0,10]:
        ...
        if dataset in class_split.keys():
            N_set=[2,5]
            K_set=[1,3,5]
        else:
            N_set=[5,10]
                ...
                for repeat in range(5):
                    ...
                    def pre_train(epoch, mode='train'):
                        ...
                        if mode=='valid' or mode=='test':
                            ...
                            #preds = query_ys_pred.type_as(query_labels)
                            #correct = preds.eq(query_labels).double()
                            #correct = correct.sum()
                            #acc_train= correct / len(query_labels)
                    ...
                    for epoch in range(args.epochs):
                        ...
                        if  epoch > 0 and epoch % 50 == 0:
                            ...
                            for epoch_test in range(20):
                                temp_accs.append(pre_train(epoch_test, mode='test'))
                    ...
                    json.dump(results[dataset],open('./TENT-result_{}_avail_{}.json'.format(dataset,avail_train_num_per_class),'w'))
